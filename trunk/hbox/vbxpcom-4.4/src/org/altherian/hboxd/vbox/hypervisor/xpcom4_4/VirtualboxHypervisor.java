...
package org.altherian.hboxd.vbox.hypervisor.xpcom4_4;
...
import org.altherian.hboxd.vbox4_4.xpcom.VbStorageControllerSubType;
import org.altherian.hboxd.vbox4_4.xpcom.VbStorageControllerType;
import org.altherian.hboxd.vbox4_4.xpcom.factory.ConnectionManager;
import org.altherian.hboxd.vbox4_4.xpcom.factory.OsTypeFactory;
import org.altherian.hboxd.vbox4_4.xpcom.manager.VbSessionManager;
import org.altherian.hboxd.vbox4_4.xpcom.service.EventsManagementService;
...
public class VirtualboxHypervisor implements _Hypervisor {
   ...
   public _RawVM createMachine(String uuid, String name, String osTypeId) {
      ...
      try {
         IMachine machine = ConnectionManager.getBox().createMachine(null, name, Arrays.asList(""), osTypeId, uuid);
