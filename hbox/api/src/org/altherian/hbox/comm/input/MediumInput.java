...
public class MediumInput extends ObjectInput implements _Actionnable {
   ...
   public MediumInput(String uuid) {
      super(uuid);
      setUuid(uuid);
      setAction(Action.Modify);
   }
   
   public MediumInput(String path, String type) {
      super(path);
      setLocation(path);
      setType(type);
   }
   
   public MediumInput(StoreItemInput siIn, String type) {
      this(siIn.getPath(), type);
   }
   
   public MediumInput(String uuid, List<SettingIO> settings) {
      super(uuid, settings);
      setUuid(uuid);
      setAction(Action.Modify);
   }
   
   public MediumInput(String uuid, String location, String type) {
      this(uuid);
      setLocation(location);
      setType(type);
   }
   
   public MediumInput(String uuid, String location, String type, String parentUuid, Set<String> childUuid) {
