...
public class UserModifiedEventOutput extends UserEventOutput {
   
   @SuppressWarnings("unused")
   private UserModifiedEventOutput() {
      // Used for serialization
   }
   
   public UserModifiedEventOutput(Date time, ServerOutput srvOut, UserOutput user) {
