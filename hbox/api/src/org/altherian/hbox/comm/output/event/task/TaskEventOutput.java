...
public abstract class TaskEventOutput extends EventOutput {
   
   protected TaskEventOutput() {
      // Used for serialization
   }
   
   public TaskEventOutput(Date time, Enum<?> id, ServerOutput srvOut, TaskOutput tOut) {
      super(time, id, srvOut);
      set(TaskOutput.class, tOut);
   }
