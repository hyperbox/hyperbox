...
public class HypervisorDisconnectedEventOutput extends HypervisorEventOutput {
   
   protected HypervisorDisconnectedEventOutput() {
      // Used for serialization
   }
   
   public HypervisorDisconnectedEventOutput(Date time, ServerOutput srvOut, HypervisorOutput hypOut) {
