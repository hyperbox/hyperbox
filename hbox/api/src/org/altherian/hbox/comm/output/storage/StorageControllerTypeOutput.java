...
public class StorageControllerTypeOutput extends ObjectOutput {
   ...
   private StorageControllerTypeOutput() {
      // Used for serialization
   }
   
   public StorageControllerTypeOutput(String typeId, long minPort, long maxPort, long maxDevicePerPort) {
      super(typeId);
