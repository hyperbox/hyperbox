...
public class StorageDeviceAttachmentOutput extends ObjectOutput {
   ...
   private StorageDeviceAttachmentOutput() {
      // Used for serialization
   }
   
   public StorageDeviceAttachmentOutput(String machineUuid, String controllerName, String mediumUuid, long portId, long deviceId, String deviceType) {
      super(machineUuid + "|" + controllerName + "|" + portId + "|" + deviceId);
