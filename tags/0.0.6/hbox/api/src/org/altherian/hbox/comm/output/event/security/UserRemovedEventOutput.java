...
public class UserRemovedEventOutput extends UserEventOutput {
   
   @SuppressWarnings("unused")
   private UserRemovedEventOutput() {
      // Used for serialization
   }
   
   public UserRemovedEventOutput(Date time, ServerOutput srvOut, UserOutput user) {
