...
package org.altherian.hbox.comm.output.network;
...
public final class NetworkInterfaceOutput extends DeviceOutput {
   
   private long nicId;
   
   @SuppressWarnings("unused")
   private NetworkInterfaceOutput() {
      // Used for serialization
   }
   
   public NetworkInterfaceOutput(Long nicId, List<SettingIO> settings) {
      super(nicId.toString(), settings);
      this.nicId = nicId;
   }
