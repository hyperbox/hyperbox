...
public final class OsTypeOutputTest {
   ...
   public static void validateSimple(OsTypeOutput osOut) {
      assertFalse(osOut.getId().isEmpty());
      assertFalse(osOut.getName().isEmpty());
      assertNotNull(osOut.getBitness());
   }
   
   public static void validateFull(OsTypeOutput osOut) {
      validateSimple(osOut);
   }
   
   public static void compareSimple(OsTypeOutput osOut01, OsTypeOutput osOut02) {
   ...
   public static void compareFull(OsTypeOutput osOut01, OsTypeOutput osOut02) {
