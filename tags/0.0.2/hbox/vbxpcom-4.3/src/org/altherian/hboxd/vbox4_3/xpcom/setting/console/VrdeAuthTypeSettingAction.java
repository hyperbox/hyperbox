...
package org.altherian.hboxd.vbox4_3.xpcom.setting.console;
...
import org.virtualbox_4_3.AuthType;
...
public class VrdeAuthTypeSettingAction implements _MachineSettingAction {
   ...
   public String getSettingName() {
      return MachineAttributes.VrdeAuthType.getId();
   }
   ...
   public _Setting get(IMachine machine) {
      return new StringSetting(MachineAttributes.VrdeAuthType, machine.getVRDEServer().getAuthType().toString());
   }
