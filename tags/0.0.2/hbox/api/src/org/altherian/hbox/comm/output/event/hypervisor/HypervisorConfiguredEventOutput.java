...
public class HypervisorConfiguredEventOutput extends HypervisorEventOutput {
   
   protected HypervisorConfiguredEventOutput() {
      // Used for serialization
   }
   
   public HypervisorConfiguredEventOutput(Date time, ServerOutput srvOut, HypervisorOutput hypOut) {
