...
public final class StoreItemInput extends ObjectInput {
   
   public StoreItemInput() {
      super("-1");
   }
   
   public StoreItemInput(String path) {
      setSetting(new StringSettingIO(StoreItemAttributes.Path, path));
   }
   
   public StoreItemInput(String name, String path) {
      this(path);
   ...
   public String getPath() {
      if (hasSetting(StoreItemAttributes.Path)) {
