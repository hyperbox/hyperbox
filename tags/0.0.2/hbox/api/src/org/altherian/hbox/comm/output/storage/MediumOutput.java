...
public class MediumOutput extends ObjectOutput {
   
   @SuppressWarnings("unused")
   private MediumOutput() {
      // Used for serialization
   }
   
   public MediumOutput(String uuid, List<SettingIO> settings) {
      super(uuid, settings);
   ...
   public boolean hasParent() {
      return hasSetting(MediumAttribute.ParentUUID);
   }
